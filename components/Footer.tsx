      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-neutral-200 pt-6 text-sm text-neutral-500 md:flex-row">
          ...
          <div className="flex gap-6">
            <Link href="https://www.instagram.com/imtakshil/?hl=en">Instagram</Link>
            <Link href="https://x.com/TakshilDev">Twitter</Link>
            <Link href="https://www.linkedin.com/in/takshilpandya/">Linkedin</Link>
          </div>
        </div>
